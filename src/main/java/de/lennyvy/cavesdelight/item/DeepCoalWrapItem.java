...
public class DeepCoalWrapItem extends Item {
	public DeepCoalWrapItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(18).saturationModifier(0.6f)
