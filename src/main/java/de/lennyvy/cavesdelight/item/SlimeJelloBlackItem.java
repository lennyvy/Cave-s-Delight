...
public class SlimeJelloBlackItem extends Item {
	public SlimeJelloBlackItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(2).saturationModifier(1.5f)
			.effect(() -> new MobEffectInstance(CavesdelightModMobEffects.ECHO_SIGHT, 800, 1), 1.0f).alwaysEdible().build()));
	}
