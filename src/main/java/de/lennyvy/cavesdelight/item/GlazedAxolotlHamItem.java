...
public class GlazedAxolotlHamItem extends Item {
	public GlazedAxolotlHamItem() {
		super(new Item.Properties().food((new FoodProperties.Builder()).nutrition(8).saturationModifier(0.8125f)
