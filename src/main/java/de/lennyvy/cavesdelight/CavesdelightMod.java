package de.lennyvy.cavesdelight;
...
public class CavesdelightMod {
	public static final Logger LOGGER = LogManager.getLogger(CavesdelightMod.class);
	public static final String MODID = "cavesdelight";

	public CavesdelightMod(IEventBus modEventBus) {
